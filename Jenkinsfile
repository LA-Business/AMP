pipeline {
    ...
    environment {
        ...
        ECR_TAG         = "amp-zupersonic"

        APP_ENV         = "Prod"
        APP_NAME        = "AMP-Zupersonic"
    ...
    stages {        
        ...
        stage("Deploy") {
            steps {
                sh "ssh -i /var/lib/jenkins/LAGaming.pem admin@172.31.21.105 'sudo sh /home/admin/feature/autodeploy-amp-zupersonic.sh'"
            }
        }
